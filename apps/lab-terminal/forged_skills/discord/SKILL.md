...
```json
{ "action": "read", "target": "channel:<channelId>", "channel_id": "123", "limit": 20 }
```
...
✅ Good:
```
versioning options: semver (1.2.3), calver (2026.01.04), or yolo (`latest` forever).
what fits your release cadence?
```
